...
class StoreController extends Controller
{
    ...
    [
        ...
        return view('admin.stores.index', compact('stores', 'recipes', 'requests', 'tours', 'events', 'subscribers', 'subscriptionSetting', 'gins', 'storeLocations', 'banner'));
    }
