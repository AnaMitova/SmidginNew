...
<head>
    ...
    <title>Додади локација - Административен Панел</title>
...
<body class="font-montserrat antialiased text-slate-800 bg-slate-50 min-h-full">
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-slate-900">Додади нова локација</h2>
            <p class="text-xs text-slate-500 mt-1">Се прикажува во модалот „Select a Location“ на страницата.</p>
        </div>

        @include('admin.store-locations.form', [
            'action'      => route('store-locations.store'),
            'method'      => 'POST',
            'submitLabel' => 'Зачувај локација',
        ])
    </main>
