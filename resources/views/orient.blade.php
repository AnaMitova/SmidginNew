...
<div id="slideshow" class="">
  ...
  <div class="md:px-32 px-7 md:pt-10 flex md:flex-row flex-col items-center justify-between">
    <div id="bottle" class="w-1/3 md:w-1/2">
      <img class="md:h-[1100] py-5 w-full h-auto md:w-[471px]" src="./sliki/orient.webp" loading="lazy" decoding="async"/>
    </div>
  ...
  <a href=""" class="group">
    <div class="flex flex-col justify-center items-center mt-20 md:mt-44">
      ...
      <img src="./sliki/light.webp"       class="md:w-[300px] md:h-[400px] w-[220px] h-[320px]
