...
@include('partials.gin-menu-strip')
  ...
  <div class="flex md:flex-row flex-col md:pt-16 justify-between md:pl-32 md:pr-40 items-center">
    ...
    <div class="md:hidden md:self-start self-center md:pt-0 pt-8">
      <p class="md:pr-24 font-montserrat text-[34px] md:text-[50px]">SMIDGIN <span class="text-[#EB504B]">LOVE</span></p>
    </div>
  </div>
  ...
  <div class="md:px-32 px-7 md:pt-10 flex md:flex-row flex-col items-center justify-between">
    <div id="bottle" class="w-1/3 md:w-1/2">
      <img class="w-full pr-28 pl-14" src="./sliki/love.jpeg" loading="lazy" decoding="async"/>
    
    </div>
    <div class="md:w-1/2 md:pr-11 flex-col flex">
      <p class="md:pr-24 hidden md:block -mt-20 pb-7 font-montserrat text-[34px] md:text-[50px]">SMIDGIN <span class="text-[#EB504B]">LOVE</span></p>
      <p class="italic text-[17px] md:text-[20px] text-gray-500 font-serif mb-12">
A lighter spirit crafted with the same Macedonian soul — distilled with juniper, citrus, and wild mountain tea.      </p>
      <a href="https://smidgin-shop.myshopify.com/products/smidgin-love-gin-700ml" class="md:self-start self-center font-montserrat px-5 py-3 bg-[#EB504B] shadow-[0_8px_16px_rgba(235,80,75,0.6)] rounded-xl text-white">BUY LOVE</a>

      <p class="text-[30px] mt-14 mb-7  font-Baskervville font-semibold"><span class="text-[#EB504B]">A Lighter </span> Expression</p>
      <p class="text-[18px] font-montserrat">
        After a year of meticulous experimentation  and countless juniper berries, citrus peels, and mountain tea petals — we reimagined the original Smidgin Classic into something refreshingly new. Smidgin Light is a low-alcohol expression of our signature gin, designed for those who seek balance without compromise. At just 18% ABV, it delivers all the flavor, with a gentler touch.
      </p>

      <p class="text-[30px] mb-7 mt-12 font-Baskervville font-semibold">Flavor & Botanicals</p>
      <p class="text-[18px] font-montserrat">
        Bright and crystal-clear, Smidgin Light opens with fresh juniper and zesty citrus on the nose, followed by a delicate floral finish from wild Macedonian mountain tea. Each sip offers the familiar depth of Smidgin Classic — only lighter, cleaner, and perfectly refined.
      </p>

      <p class="text-[30px] mb-7 mt-12 font-Baskervville font-semibold">How To <span class="text-[#EB504B]">Enjoy</span> It</p>
  ...
  <!-- Next Product -->
@include('partials.gin-next', ['currentSlug' => 'orient'])
