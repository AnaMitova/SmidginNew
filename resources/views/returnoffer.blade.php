...
<!-- Back Button -->
<a href="javascript:history.back()" class="font-montserrat md:px-32 px-7 pt-12 flex items-center">
    <i class="fa-solid fa-arrow-left pr-4"></i>BACK
</a>

<!-- Page Title -->
<div class="flex flex-col -space-y-2 mt-3 md:-mt-0 md:pt-6 md:space-y-3 pb-12 md:pb-20 px-7 md:px-32">
    <h1 class="font-Baskervville text-[28px] md:text-5xl">SMIDGIN BOTTLE</h1>
    <h1 class="font-Baskervville text-[28px] md:text-5xl"><span class="text-red-500">RETURN</span> OFFER</h1>
</div>

<!-- Content -->
<div class="flex flex-col md:flex-row px-7 md:px-32 space-y-12 md:-space-y-2 md:space-x-24 pb-20">
    <img src="./img/return.webp" class="w-full md:w-1/2 rounded-3xl" loading="lazy" decoding="async"/>
    <p class="font-montserrat text-[17px] md:text-[18px] md:w-1/2">
        <b>At Smidgin we like to be aware of how our work affects the environment.</b> We are working hard to completely eliminate all single-use plastics from the distillery while seeking to continually improve our energy efficient heating process for our copper alembic still and label all of our bottles by hand at our MCM distillery.<br/><br/>
        We love our bottle design and we think that the quality and feel of the Smidgin bottle reflects the love and care we put into making gin.<br/><br/>
        Manufacturing glass is an energy-intensive process, and we hate to think that our bottles are being thrown away. <b>With the current energy crisis we can all do a little bit to help reduce waste.</b> This is why we are now offering all our customers a <b>62 denars</b> discount on your next bottle of Smidgin for every empty bottle that you return to us. If you bring back 3 bottles, get a 186 Dinar discount and so on.<br/><br/>
        Just drop your empty Smidgins at MCM and our team will give you either an instant discount or a coupon to use on your next purchase. We will remove the label, clean and sterilise the bottle so that we can re-use it. Our tests have shown that by using 96.4% pure alcohol we can remove the label and 100% of any traces of dirt or bacteria, making the bottle as good as new.<br/><br/>
        <b class="md:hidden block">If you feel the same way as we do, that we can all contribute to reducing waste of energy and materials, please help us to do our part by recycling and reusing the beautiful Smidgin glass bottle.</b>
    </p>
</div>
    <p class=" md:px-32 hidden md:block font-montserrat text-[17px] md:text-[18px]">
        <b>If you feel the same way as we do, that we can all contribute to reducing waste of energy and materials, please help us to do our part by recycling and reusing the beautiful Smidgin glass bottle.</b>
    </p>
